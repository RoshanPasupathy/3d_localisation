...
if ret == True:
	...
	corner = tuple(corners[0].ravel())
	cv2.line(frame1, corner, tuple(imgpts[0].ravel()), (255,0,0), 1)
	cv2.line(frame1, corner, tuple(imgpts[1].ravel()), (0,255,0), 1)
	cv2.line(frame1, corner, tuple(imgpts[2].ravel()), (0,0,255), 1)
