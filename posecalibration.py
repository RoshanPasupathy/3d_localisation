...
def draw2(img,corners):
	img = cv2.rectangle(img,tuple(corners[0].ravel()),tuple(corners[20].ravel()),(0,255,0),1)
	return img
	
mtx = np.array([[ 511.78922,0, 314.76367],[0,512.44537,268.54549],[0,0,1]],dtype=np.float64)
dist = np.array([0.07220,-0.15304,0.00269 ,-0.00064,0.00000],dtype=np.float64)
...
if ret == True:
	...
	print tvecs
	np.savez('/home/pi/ip/pose.npz',R=R,rvecs=rvecs,tvecs=tvecs)
	...
	cv2.imwrite('/home/pi/ip/report/posecalibrate4.bmp',frame1)
	cv2.imwrite('/home/pi/ip/report/withoutaxes.bmp',frameorig)
	l = 1
