...
def socketcomm(port,pipec, pipeu,pipesoc,dat_size = 156):
...
#set process
proc1 = Process(target=socketcomm,args=(port1,pipecf1,pipeuf1,pipesockf1))
...
#set process
proc2 = Process(target=socketcomm,args=(port2,pipecf2,pipeuf2,pipesockf2))
...
try:
	...
	while runflag:
		...
		if datrecv1[0] and datrecv2[0]:
			pos3d =  retfunc(datrecv1[1],datrecv2[1]) ########
