...
ax4.scatter(satdata,valdata, c=colours3,marker='o')
ax4.plot([x0min,x1min],[y0min,y1min],'-g')
ax4.plot([x0max,x1max],[y0max,y1max],'-g') 

cb4 = fig4.colorbar(colmap3,shrink=0.75)
cb4.set_label('frequency')
ax4.set_title('Intenisty vs. Saturation') 
